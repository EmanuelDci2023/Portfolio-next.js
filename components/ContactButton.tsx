...
export default function Example() {
  return (
    <Popover placement="bottom-end">
      <PopoverHandler>
        <Button className="mdLg:ml-6 cursor-pointer rounded-full bg-gradient-to-r from-pink-800 to-violet-900 p-3 text-base text-slate-200 hover:from-pink-700 hover:to-violet-800">
          Contact me
        </Button>
      </PopoverHandler>
        ...
        <List className="p-0 text-white-100">
          ...
          <a href="#" className="text-initial font-medium text-blue-gray-500">
            <ListItem>
              ...
              <div>
                rusu.emanuel.webdeveloper <br /> @gmail.com
              </div>
            </ListItem>
          </a>
        </List>
