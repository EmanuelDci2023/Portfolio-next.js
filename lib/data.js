...
export const skills = [
  ...
  },
  {
    ...
    header: "Frontend Development",
    icon: <IconBrandBootstrap className="h-4 w-4 text-neutral-500" />,
    uniqueText:
      "Creating responsive and mobile-first websites with pre-built components and utilities.",
    images: bootstrap,
  },
];
...
export const projects = [
  {
    ...
    link: "https://github.com/EmanuelDci2023/Project-Gym-Webpage",
  },
  {
    id: 2,
